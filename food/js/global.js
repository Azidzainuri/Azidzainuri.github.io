...
/* ===== INVOICE ===== */
function formatInvoice(date,inv) {
...
var tombolRemove = '<svg style="width:24px;height:24px" viewBox="0 0 24 24"><path fill="currentColor" d="M9,3V4H4V6H5V19A2,2 0 0,0 7,21H17A2,2 0 0,0 19,19V6H20V4H15V3H9M7,6H17V19H7V6M9,8V17H11V8H9M13,8V17H15V8H13Z"></path></svg>';
        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                image: function (item, column) {
                    return ["<a href='" + item.get(column.attr) + "'><img alt='image product' src='" + item.get(column.attr) + "'/></a>"];
                },
...
$(".button-form").click(function(){
  $(".box-checkout").slideToggle("normal");
  return false;
});

$("#button-checkot").click(function(){
  var nama = $("#nama").val();
  var nomor = $("#nomor").val();
  ...
  if (nama == ""){
    ...
    notification("Nomor HP diperlukan");
    return false;
  } else if (alamat == ""){
    notification("Alamat diperlukan");
    return false;
  } else if (pengiriman == "default"){
    notification("Pengiriman diperlukan");
    return false;
  } else if (pembayaran == "default"){
    notification("Pembayaran diperlukan");
    return false;
  } else {
    var date = new Date();
