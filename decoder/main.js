...
(function () {
    ...
    var input = document.getElementById('input'),
        ...
        externalPreview = function (source) {
            ...
            source = '<html><head><meta charset="utf-8"><link rel="shortcut icon" type="image/png" href="favicon.png"><title> Preview</title><style>' + externalStyle + '</style></head><body><pre class="hljs">' + source + '</pre></body></html>';
        ...
        format = debounce(function () {
            ...
            if (!workerFormat) {
                workerFormat = new Worker('format.js');
        ...
        decode = debounce(function () {
            ...
            if (!workerDecode) {
                workerDecode = new Worker('decode.js');
